<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Inicio.aspx.cs" Inherits="WebApplication1_TLPC.Inicio" %>
                        ...
                        <div class="modal-body">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <!-- Ahora agregamos un boton para el modal -->
                                    <div class="col-sm-1">
                               ...
                               <div class="m-t-small">
                                ...
                                <!-- Hacer un script para agregar mapa al modal -->
                                <script>
